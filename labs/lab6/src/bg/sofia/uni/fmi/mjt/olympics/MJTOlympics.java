...
public class MJTOlympics implements Olympics {
	...
	@Override
	public void updateMedalStatistics(Competition competition) {//check exceptions, check correct addition; might test getRankList
	...
	private void updateMedalTable(Competitor competitor, Medal medal) {
		...
		nationMedals.put(medal, nationMedals.getOrDefault(medal, 0) - 1);//+1?
	}
	...
	public int getTotalMedals(String nationality) {
		...
		Map<Medal, Integer> nationMedals = nationsMedalTable.get(nationality);
